...
.movie_body .info_list h2{ font-size: 16px; line-height: 24px; width:150px; overflow: hidden; white-space: nowrap; text-overflow:ellipsis;}
...
.movie_body .info_list .grade{ font-weight: 700; color: #faaf00; font-size: 14px;}
