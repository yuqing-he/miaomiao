...
<style scoped>
#footer{ width:100%; height:44px; background: white; border-top:2px #ebe8e3 solid; position: fixed; left: 0; bottom:0;}
#footer ul{ display: flex; text-align: center; height:44px; align-items:center;}
#footer ul li{ flex:1; height:38px;}
