...
.register_body .register_text{ width:100%; height: 40px; border:none; border-bottom: 1px #ccc solid; margin-bottom: 8px; outline: none; text-indent: 12px;}
.register_body .register_btn{ height:44px; margin:12px;}
.register_body .register_email{ position: relative;}
.register_body .register_email button{ position: absolute; right:10px; top:10px; font-size: 12px; border-radius: 8px; border:none; padding:8px;}
.register_body .register_btn button{ width:100%; height:100%; background:#e54847; border-radius: 8px; border:none; display: block; color:white; font-size: 16px;}
.register_body .register_link{ display: flex; justify-content:space-between;}
.register_body .register_link a{ text-decoration: none; margin:0 12px; font-size: 12px; color:#e54847;}
</style>
